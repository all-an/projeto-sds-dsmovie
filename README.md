...
### FAVOR AGUARDAR A PÁGINA ABAIXO ABRIR, É UM HOST GRATUITO POR ISSO ELE ENTRA EM STANDBY APÓS FICAR SEM USO.

[Deploy do Front-End no Netlify](https://all-an-projeto-dsmovie.netlify.app/)

### O BACKEND PODE SER TESTADO PELO POSTMAN OU UTILIZANDO UM JSONFORMATTER NO NAVEGADOR
